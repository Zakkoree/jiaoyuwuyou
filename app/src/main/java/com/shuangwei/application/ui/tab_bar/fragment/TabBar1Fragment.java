...
import com.shuangwei.application.ui.vm.TabBar1ViewModel;
...
public class TabBar1Fragment extends BaseFragment{
    ...
    public TabBar1ViewModel initViewModel() {
        return new TabBar1ViewModel(this.getActivity());
    }
    ...
    public void initData(){        // 初始化布局 View视图
        init();
        coverflow();
        cepingImageView = binding.getRoot().findViewById(R.id.cepingImageView);
        cepingImageView.setOnClickListener(onCepingClickListener);
    }
    ...
    private OncepingClick OncepingClick;
    private ImageView cepingImageView;

    //测评点击事件
    public ImageView.OnClickListener onCepingClickListener=new ImageView.OnClickListener() {
        @Override
        public void onClick(View v) {
            //图片点击事件
            if (OncepingClick != null) {
                OncepingClick.onClick(cepingImageView);
            }
        }
    };

    public OncepingClick getOncepingClick() {
        return OncepingClick;
    }

    public void setOncepingClick(OncepingClick OncepingClick) {
        this.OncepingClick = OncepingClick;
    }
    public interface OncepingClick{
    ...
    private void init(){
        ...
        urlMaps.put("Big Bang Theory", "http://img.bss.csdn.net/201611011748472733.jpg");
